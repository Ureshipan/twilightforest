...
public final class TreeDecorators {
	public static final BlockStateProvider ROOT_BLEND_PROVIDER = new WeightedStateProvider(new WeightedList.Builder<BlockState>().add(TFBlocks.ROOT_BLOCK.get().defaultBlockState(), 6).add(TFBlocks.LIVEROOT_BLOCK.get().defaultBlockState(), 1).build());
